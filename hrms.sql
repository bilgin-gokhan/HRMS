CREATE TABLE public.users(
	...
	email CHARACTER VARYING(325) NOT NULL,
...
CREATE TABLE public.employee_confirm_employees(
	id INT NOT NULL,
	employer_id INT NOT NULL,
	CONSTRAINT pk_employee_confirm_employees PRIMARY KEY(id),
	CONSTRAINT fk_employee_confirm_employees_employee_confirms FOREIGN KEY(id) REFERENCES public.employee_confirms(id),
	CONSTRAINT fk_employee_confirm_employees_employers FOREIGN KEY(employer_id) REFERENCES public.employers(id)
);
